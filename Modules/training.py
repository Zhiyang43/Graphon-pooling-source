...
class Trainer:
    ...
    def trainBatch(self, thisBatchIndices):
        ...
        costTrain = self.data.evaluate(yHatTrain.data, yTrain.long())
    ...
    def validationStep(self):
        ...
        with torch.no_grad():
            ...
            # Compute loss
            lossValueValid = self.model.loss(yHatValid, yValid.long())
            ...
            # Compute accuracy:
            costValid = self.data.evaluate(yHatValid, yValid.long())
